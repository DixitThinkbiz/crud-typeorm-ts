...
// Add Dummy Usecase
export const addDummyUsecase = async (DummyRepo:DummyRepositoryPort,dummyData: Dummy,t:EntityManager) => {
    // Check if a dummy with the specified email already exists
    const selectedDummy : AuthLogin= await DummyRepo.checkDummyEmailExist(dummyData.email,t);
